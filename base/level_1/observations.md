...
- I tried with both resnet-18 and resnet-20 and resnet-18 performed slightly better. I think this is because although resnet-18 has less layers, it has more parameters which give the model more thinking capability. If the architecture is too deep it should have betetr capabilities however, I noticed that overfitting can occur.
...
- Deciding the architecture: There were so many different kinds of resnet architectures available, I tried them all but found that I didn't like completely overpowered models with a ton of parameters. I liked resnet 20's way. _I also tried my own architectures too, changing the funneling, dimensions, etc. and reached a point I felt satisfied with._
